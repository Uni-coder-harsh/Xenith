...
FILES_TO_TOUCH = [
    ...
    "docs/architecture/presolve_design.md",
    ...
    "docs/decisions/ADR-011-warm-start-reoptimization.md",
    "docs/decisions/ADR-012-reversible-presolve-stack.md",
    "docs/roadmap.md",
    "docs/status.md",
    "docs/work_log.md",
    ...
    "tests/unit/io/test_mps_reader.cpp",
    ...
    "tests/data/mps/bound_types.mps",
    "tests/data/mps/integer_markers.mps",
